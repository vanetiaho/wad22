...
export async function checkAndAwardStreakPoints(userId) {
  try {
    ...
    // Award 5 points for every 10 consecutive days
    if (streak > 0 && streak % 10 === 0) {
      console.log('🎯 Streak is a 10-day milestone - awarding points!')
      ...
      console.log(`⏭️ Streak is ${streak} days, not a 10-day milestone - no points awarded`)
    }
