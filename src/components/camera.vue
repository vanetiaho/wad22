      ...
      <div v-if="capturedPhoto" class="photoPreview">
        ...
        <div class="photoControls">
          ...
          <button
            ...
            :disabled="isUploading"
          >
            <svg width="20" height="20" viewBox="-1.5 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M8.586 5H6.5A4.5 4.5 0 1 0 11 9.5a1 1 0 1 1 2 0A6.5 6.5 0 1 1 6.5 3h2.086L7.293 1.707A1 1 0 0 1 8.707.293l3 3a1 1 0 0 1 0 1.414l-3 3a1 1 0 0 1-1.414-1.414z" fill="#6D412A"/></svg> Retake
          </button>
        </div>
      </div>
